              ...
              {divisions.map((division) => (
                <div key={division.title} className="relative pt-3 lg:pt-0">
                  <div className="flex lg:block gap-5">
                    <div className={`relative z-10 w-16 h-16 rounded-full ${division.iconBg} ${division.border} border flex items-center justify-center flex-shrink-0`}>
                      <division.icon className={`h-7 w-7 ${division.accent}`} />
                    </div>
                    <div className={`lg:mt-8 pl-5 lg:pl-0 border-l lg:border-l-0 ${division.border}`}>
                      <span className="text-xs font-semibold tracking-[0.2em] text-[var(--luxury-muted)]">{division.label}</span>
                      <p className={`mt-4 text-sm uppercase tracking-[0.18em] font-semibold ${division.accent}`}>
                        {t(division.note)}
                      </p>
                      <h3 className="text-2xl font-bold text-[var(--luxury-ink)] mt-4 mb-4 leading-snug">{t(division.title)}</h3>
                      <p className="text-[var(--luxury-muted)] leading-relaxed">{t(division.desc)}</p>
                    </div>
                  </div>
                </div>
              ))}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-[0.95fr_1.05fr] gap-12 lg:gap-16 items-start">
          <div className="lg:sticky lg:top-28">
            ...
            <h2 className="text-4xl lg:text-6xl font-light text-[var(--luxury-ink)] mb-8 leading-tight">{t('aboutUsTitle')}</h2>
            ...
            <div className="relative overflow-hidden rounded-3xl bg-[var(--luxury-panel)] p-8 shadow-2xl">
              ...
              <div className="relative">
                <p className="text-sm font-medium uppercase tracking-[0.25em] text-[var(--luxury-champagne)] mb-4">{t('missionStatementLabel')}</p>
                <p className="text-3xl font-light text-[var(--luxury-on-dark)] leading-tight mb-6">{t('missionQuote')}</p>
          ...
          <div className="space-y-8">
            <div className="border-l-2 border-[var(--luxury-champagne)] pl-8">
              <p className="text-lg text-[var(--luxury-muted)] leading-relaxed">{t('aboutUsDesc')}</p>
            </div>
              ...
              {pillars.map((pillar) => (
                ...
                >
                  <div className="flex items-start gap-5">
                    <div className={`w-12 h-12 rounded-2xl bg-gradient-to-br ${pillar.bg} flex items-center justify-center flex-shrink-0`}>
                      <pillar.icon className={`h-7 w-7 ${pillar.color}`} />
                    </div>
                    <div>
                      <h3 className="text-xl font-bold text-[var(--luxury-ink)] mb-3">{t(pillar.title)}</h3>
                      <p className="text-[var(--luxury-muted)] leading-relaxed">{t(pillar.desc)}</p>
                    </div>
                  </div>
                </div>
              ))}
        ...
        <div className="border-y border-[var(--luxury-border)] mb-12">
          <div className="grid md:grid-cols-[220px_1fr] gap-6 md:gap-10 py-8 border-b border-[var(--luxury-border)] items-center">
            <div className="h-16 flex items-center">
              <img src={`data:image/png;base64,${kayTripLogo}`} alt="Kaytrip" className="max-h-14 max-w-[180px]" />
            </div>
            <div className="grid lg:grid-cols-[240px_1fr] gap-3 lg:gap-8 lg:items-center">
              <h3 className="text-2xl font-bold text-[var(--luxury-ink)]">Kaytrip</h3>
              <p className="text-[var(--luxury-muted)] leading-relaxed">{t('kaytripDesc')}</p>
            </div>
          </div>

          <div className="grid md:grid-cols-[220px_1fr] gap-6 md:gap-10 py-8 border-b border-[var(--luxury-border)] items-center">
            <div className="h-16 flex items-center">
              <img src={`data:image/png;base64,${dreamJapanLogo}`} alt="DreamJapan" className="max-h-14 max-w-[180px]" />
            </div>
            <div className="grid lg:grid-cols-[240px_1fr] gap-3 lg:gap-8 lg:items-center">
              <h3 className="text-2xl font-bold text-[var(--luxury-ink)]">DreamJapan</h3>
              <p className="text-[var(--luxury-muted)] leading-relaxed">{t('dreamJapanDescDetail')}</p>
            </div>
          </div>

          <div className="grid md:grid-cols-[220px_1fr] gap-6 md:gap-10 py-8 items-center">
            <div className="h-16 flex items-center">
              <img src={`data:image/png;base64,${vitLogo}`} alt="VIT" className="max-h-14 max-w-[180px]" />
            </div>
            <div className="grid lg:grid-cols-[240px_1fr] gap-3 lg:gap-8 lg:items-center">
              <h3 className="text-2xl font-bold text-[var(--luxury-ink)]">VIT Travel</h3>
              <p className="text-[var(--luxury-muted)] leading-relaxed">{t('vitDesc')}</p>
            </div>
          </div>
        </div>

        <div className="text-center">
          <p className="text-xl text-[var(--luxury-muted)] italic">{t('portfolioTagline')}</p>
        </div>
      </div>
    </section>
  )
...
export function GsaCapabilitiesSection() {
  ...
  const capabilities = [
    { title: 'gsa1Title', desc: 'gsa1Desc', icon: ShieldCheck, color: 'text-[var(--luxury-gold)]', bg: 'from-[#F3E8D5] to-[#E6D3AE]' },
    { title: 'gsa2Title', desc: 'gsa2Desc', icon: Crown, color: 'text-[var(--luxury-gold)]', bg: 'from-[#F3E8D5] to-[#E6D3AE]' },
    { title: 'gsa3Title', desc: 'gsa3Desc', icon: Sparkles, color: 'text-[var(--luxury-midnight)]', bg: 'from-[#EFE7DB] to-[#DDD2C1]' },
    { title: 'gsa4Title', desc: 'gsa4Desc', icon: GraduationCap, color: 'text-[var(--luxury-sage)]', bg: 'from-[#E7E7DE] to-[#D7DDD5]' },
    { title: 'gsa5Title', desc: 'gsa5Desc', icon: Megaphone, color: 'text-[var(--luxury-sage)]', bg: 'from-[#E7E7DE] to-[#D7DDD5]' },
    { title: 'gsa6Title', desc: 'gsa6Desc', icon: BarChart3, color: 'text-[var(--luxury-midnight)]', bg: 'from-[#EFE7DB] to-[#DDD2C1]' },
  ]
    ...
    <section id="services" className="py-24 bg-[var(--luxury-alternate)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          ...
          <h2 className="text-4xl lg:text-6xl font-light text-[var(--luxury-ink)] mb-8 leading-tight">{t('gsaTitle')}</h2>
          <p className="text-xl text-[var(--luxury-muted)] max-w-4xl mx-auto font-light leading-relaxed">{t('gsaSubtitle')}</p>
        </div>
          ...
          {capabilities.map((cap, idx) => (
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[var(--luxury-ink)] mb-3">{t(cap.title)}</h3>
                  <p className="text-[var(--luxury-muted)] leading-relaxed">{t(cap.desc)}</p>
                </div>
              </div>
            </div>
          ))}
...
export function WhyChooseUsSection() {
  ...
  const reasons = [
    { title: 'whyChoose1', desc: 'whyChoose1Desc', icon: Gem, color: 'text-[var(--luxury-gold)]', bg: 'from-[#F3E8D5] to-[#E6D3AE]' },
    { title: 'whyChoose2', desc: 'whyChoose2Desc', icon: Globe2, color: 'text-[var(--luxury-midnight)]', bg: 'from-[#EFE7DB] to-[#DDD2C1]' },
    { title: 'whyChoose3', desc: 'whyChoose3Desc', icon: Languages, color: 'text-[var(--luxury-sage)]', bg: 'from-[#E7E7DE] to-[#D7DDD5]' },
    { title: 'whyChoose4', desc: 'whyChoose4Desc', icon: ShieldCheck, color: 'text-[var(--luxury-midnight)]', bg: 'from-[#EFE7DB] to-[#DDD2C1]' },
    { title: 'whyChoose5', desc: 'whyChoose5Desc', icon: LockKeyhole, color: 'text-[var(--luxury-gold)]', bg: 'from-[#F3E8D5] to-[#E6D3AE]' },
  ]
    ...
    <section className="py-24 bg-[var(--luxury-background)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          ...
          <h2 className="text-4xl lg:text-6xl font-light text-[var(--luxury-ink)] mb-8 leading-tight">{t('whyChooseTitle')}</h2>
          <p className="text-xl text-[var(--luxury-muted)] max-w-4xl mx-auto font-light leading-relaxed">{t('whyChooseSubtitle')}</p>
        </div>
        ...
        <div className="grid lg:grid-cols-6 gap-8">
          {reasons.map((reason, idx) => (
            ...
            >
              <div className="flex items-start gap-5">
                <div className={`relative w-16 h-16 rounded-2xl bg-gradient-to-br ${reason.bg} flex items-center justify-center flex-shrink-0`}>
                ...
                <div>
                  <h3 className="text-xl font-bold text-[var(--luxury-ink)] mb-3">{t(reason.title)}</h3>
                  <p className="text-[var(--luxury-muted)] leading-relaxed">{t(reason.desc)}</p>
                </div>
              </div>
            </div>
          ))}
  ...
  return (
    <section className="py-24 bg-gradient-to-br from-[var(--luxury-midnight)] to-[var(--luxury-panel)] relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <form onSubmit={handleSubmit} className="bg-[var(--luxury-surface)] rounded-3xl p-12 shadow-2xl space-y-6">
          ...
          <p className="text-center text-[var(--luxury-muted)] text-sm">{t('sendMessageDesc')}</p>
        </form>
      </div>
    </section>
  )
